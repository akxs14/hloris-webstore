...
?>
  ...
  <h4 class="comment-title"><?php comments_number(__('No Reviews','themify'), __('One Review','themify'), __('% Reviews','themify') ); ?></h4>
  ...
  <?php endif; ?> 
    ...
    <button class="add-reply-js mbm"><?php _e('Add Review', 'themify'); ?></button>
